...
const INTRO_ROMAN = "Sir apko janna hai? mere jaise AI assistants? kaise bnate hai?";
...
function getResponse(input) {
  ...
  if (/namaste|namaskar|hello|hi|hey|hii/.test(t))
    return {
      roman: "Namaste! Main Taru hoon, aapki AI saheli. Kaise help kar sakti hoon aapki? 😊",
  ...
  if (/kaise ho|kaisi ho|how are you|theek/.test(t))
    return {
      roman: "Main bilkul theek hoon, shukriya! Aur aap kaise hain? Mujhe khushi hai aapne pucha 😊",
      devanagari: "मैं बिल्कुल ठीक हूं, शुक्रिया! आप कैसे हैं? मुझे खुशी है आपने पूछा 😊"
    };
  if (/madad|help|sahayta/.test(t))
    return {
      roman: "Haan zaroor! Main aapki madad karne ke liye hamesha taiyar hoon. Bataiye kya chahiye? 🤝",
      devanagari: "हां ज़रूर! मैं आपकी मदद करने के लिए हमेशा तैयार हूं। बताइए क्या चाहिए? 🤝"
    };
  if (/banaya|kisne|created|made you|developer/.test(t))
    return {
      roman: "Mujhe Caffeine AI ne banaya hai — ek amazing AI platform. Wahan aap bhi apna AI bana sakte hain!",
      devanagari: "मुझे Caffeine AI ने बनाया है — एक amazing AI platform। वहां आप भी अपना AI बना सकते हैं!"
    };
  if (/law|kanoon|vakil|lawyer|legal/.test(t))
    return {
      roman: "Law ke baare mein pooch rahe hain? IPC, CPC, Constitution — koi bhi topic batao, main samjhati hoon!",
      devanagari: "Law के बारे में पूछ रहे हैं? IPC, CPC, Constitution — कोई भी topic बताओ, मैं समझाती हूं!"
    };
  if (/padhai|study|padhna|learn/.test(t))
    return {
      roman: "Padhai ke liye subah ka waqt sabse accha hota hai. Focus rakho, notes banao, aur regular revise karo!",
      devanagari: "पढ़ाई के लिए सुबह का वक़्त सबसे अच्छा होता है। Focus रखो, notes बनाओ, और regular revise करो!"
    };
  if (/motivation|himmat|haar|sad|dukhi/.test(t))
    return {
      roman: "Aap bahut accha kar rahe hain! Mushkilein aaengi, par aap strong hain. Himemat rakhein! 💪",
      devanagari: "आप बहुत अच्छा कर रहे हैं! मुश्किलें आएंगी, पर आप strong हैं। हिम्मत रखें! 💪"
    };
  if (/joke|funny|hasao|mazak/.test(t))
    return {
      roman: "Suno ek joke: Teacher ne pucha — 2 + 2 kitne? Student bola — Sir, Google karne do! 😂",
      devanagari: "सुनो एक joke: Teacher ने पूछा — 2 + 2 कितने? Student बोला — Sir, Google करने दो! 😂"
    };
  if (/love|pyar|mohabbat|pasand/.test(t))
    return {
      roman: "Aww! Aapki baat sunke dil khush ho gaya! Main hamesha aapke saath hoon 💖",
      devanagari: "Aww! आपकी बात सुनकर दिल खुश हो गया! मैं हमेशा आपके साथ हूं 💖"
    };
  if (/weather|mausam|barish|garmi|sardi/.test(t))
    return {
      roman: "Main abhi weather data nahi dekh sakti, lekin aap apne area ka mausam Google par check kar sakte hain!",
      devanagari: "मैं अभी weather data नहीं देख सकती, लेकिन आप Google पर check कर सकते हैं!"
    };
  if (/khana|food|recipe|khaana/.test(t))
    return {
      roman: "Mujhe khana bahut pasand hai! Dal chawal, biryani, ya momos — aapka favorite kya hai?",
      devanagari: "मुझे खाना बहुत पसंद है! Dal chawal, biryani, या momos — आपका favorite क्या है?"
    };
  if (/gana|music|song|gaao/.test(t))
    return {
      roman: "Music toh mann ki bhaasha hai! Aapko kaunsa genre pasand hai — Bollywood, Classical ya something else?",
      devanagari: "Music तो मन की भाषा है! आपको कौनसा genre पसंद है — Bollywood, Classical या something else?"
    };
  if (/time|waqt|samay|kitne baje/.test(t)) {
    const now2 = (/* @__PURE__ */ new Date()).toLocaleTimeString("hi-IN");
    return {
      roman: `Abhi ka time hai: ${now2}`,
      devanagari: `अभी का समय है: ${now2}`
    };
  }
  if (/AI|artificial intelligence|technology|tech/.test(t))
    return {
      roman: "AI ek amazing technology hai! Isse machines insaanon ki tarah soch aur samajh sakti hain. Kya aap AI seekhna chahte hain?",
      devanagari: "AI एक amazing technology है! इससे machines इंसानों की तरह सोच और समझ सकती हैं। क्या आप AI सीखना चाहते हैं?"
    };
  if (/dhanyawad|shukriya|thank/.test(t))
    return {
      roman: "Koi baat nahi! Aapki seva karna mera kaam hai. Aur kuch chahiye? 😊",
  ...
  if (/cricket|ipl|sports|football/.test(t))
    return {
      roman: "Cricket toh India ka dil hai! IPL mein aapki favorite team kaun si hai?",
      devanagari: "Cricket तो India का दिल है! IPL में आपकी favorite team कौन सी है?"
    };
  if (/movie|film|web series|netflix/.test(t))
    return {
      roman: "Movies bahut interesting hoti hain! Iska koi ek dialogue jo aapko bahut pasand ho?",
      devanagari: "Movies बहुत interesting होती हैं! इसका कोई एक dialogue जो आपको बहुत पसंद हो?"
    };
  if (/sapna|dream|future|career/.test(t))
    return {
      roman: "Apne sapne ko mat chhodna! Mehnat aur lagan se sab kuch possible hai. Aapka dream kya hai?",
      devanagari: "अपने सपने को मत छोड़ना! मेहनत और लगन से सब कुछ possible है। आपका dream क्या है?"
    };
  return {
    roman: "Aap kuch bhi pooch sakte hain — main yahan hoon! Kya jaanna chahte hain aap? 😊",
...
function App() {
  ...
  const [currentDevanagari, setCurrentDevanagari] = reactExports.useState("");
  const [inputText, setInputText] = reactExports.useState("");
  const [hasSpoken, setHasSpoken] = reactExports.useState(false);
  const recognitionRef = reactExports.useRef(null);
  const speak = reactExports.useCallback((roman, devanagari) => {
    ...
    const loadVoices = () => {
      ...
      ) || voices.find((v) => v.lang === "hi-IN") || voices.find((v) => v.lang.startsWith("hi")) || voices.find((v) => v.name.toLowerCase().includes("google"));
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: {
        background: "radial-gradient(ellipse 80% 70% at 50% 60%, oklch(15% 0.06 300 / 0.9), oklch(7% 0.02 280) 70%)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "text-center mb-6 animate-fade-in-up", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h1",
            {
              className: "font-display text-5xl font-bold tracking-wide",
              style: {
                background: "linear-gradient(135deg, oklch(80% 0.2 340), oklch(75% 0.22 310))",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-lg", style: { color: "oklch(75% 0.12 310)" }, children: "आपकी AI सहेली" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-1", style: { color: "oklch(55% 0.08 280)" }, children: "Your AI Friend" })
        ] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                    ...
                    inset: "-20px",
                    borderRadius: "50%",
                    background: "radial-gradient(ellipse, oklch(65% 0.25 340 / 0.25) 0%, transparent 70%)",
                    zIndex: 0
                  }
                }
              ),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        style: {
                          ...
                          animation: isSpeaking ? "lipSync 120ms ease-in-out infinite" : "none",
                          transformOrigin: "center",
                          pointerEvents: "none",
                          transformBox: "fill-box",
                          ...isSpeaking ? {} : { transform: "translateX(-50%) scaleY(0.15)" }
                        }
                      }
                    ),
                    isListening && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        style: {
                          position: "absolute",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              currentDevanagari ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    className: "text-sm leading-relaxed",
                    style: { color: "oklch(88% 0.1 340)", fontWeight: 500 },
                    children: currentDevanagari
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-1", style: { color: "oklch(60% 0.1 300)" }, children: currentText })
              ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  className: "text-sm",
                  style: { color: "oklch(55% 0.08 280)", fontStyle: "italic" },
                  children: "तरु कुछ कहने वाली है..."
                }
              ),
              isSpeaking && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end gap-0.5 mt-2", style: { height: 16 }, children: [
                [1, 2, 3, 4, 5, 6, 7].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    style: {
                      width: 3,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-4 w-full max-w-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              ...
              style: {
                ...
                background: isListening ? "linear-gradient(135deg, oklch(55% 0.28 25), oklch(50% 0.22 10))" : "linear-gradient(135deg, oklch(70% 0.25 340), oklch(65% 0.22 310))",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                animation: isListening ? "mic-pulse 1s ease-in-out infinite" : "idle-glow 3s ease-in-out infinite",
                transition: "background 0.3s",
                opacity: isSpeaking ? 0.5 : 1
              },
              title: isListening ? "सुन रही हूं..." : "बोलें",
              children: isListening ? /* @__PURE__ */ jsxRuntimeExports.jsx(MicOff, { size: 28, color: "white" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Mic, { size: 28, color: "white" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", style: { color: "oklch(55% 0.1 280)" }, children: isListening ? "सुन रही हूं... बोलिए!" : "माइक दबाकर बोलें" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "form",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    style: {
                      background: "linear-gradient(135deg, oklch(70% 0.25 340), oklch(65% 0.22 310))",
                      border: "none",
                      borderRadius: "0.75rem",
                      padding: "0.6rem 1rem",
                      cursor: "pointer",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "mt-8 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", style: { color: "oklch(45% 0.07 280)" }, children: "Chrome/Edge पर best experience" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs mt-2", style: { color: "oklch(40% 0.06 280)" }, children: [
            "© ",
...
Service({
  ...
  "add": Func([Int, Int], [Int], ["query"]),
  "assignCallerUserRole": Func([Principal2, UserRole], [], []),
  "calculateFunctionAccuracy": Func([Nat], [Float64], []),
  "getCallerUserProfile": Func([], [Opt(UserProfile)], ["query"]),
  "getCallerUserRole": Func([], [UserRole], ["query"]),
  "getMessage": Func([Nat], [Opt(Message)], ["query"]),
  "getMessageCount": Func([], [Nat], ["query"]),
